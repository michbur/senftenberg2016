...
Features extracted using n-gram analysis are informative enough to train accurate detectors of amyloidogenicity.  

They may also be used to explain the mechanism of amyloid aggregation.
